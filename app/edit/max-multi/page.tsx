    ...
    <div className="min-h-screen">
      ...
      <div className="text-center mb-8 pc:mb-12">
        <div className="flex items-center justify-center mb-4 pc:mb-6">
          <Layers className="w-6 h-6 pc:w-8 pc:h-8 text-primary-600 mr-2" />
          <h2 className="text-2xl pc:text-3xl lg:text-4xl font-bold text-gray-900">FLUX.1 Kontext Max Multi 多图编辑</h2>
        </div>
